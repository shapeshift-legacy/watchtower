# 
# Sets up proxy object for rpc calls to the bitcoin node
#
# This module derived from https://github.com/instagibbs/CoreFeeHelper
...
log = logging.getLogger('watchtower.common.services.authproxy')
...
class AuthServiceProxy():
    ...
    def _set_conn(self, connection=None):
        ...
        if connection:
            ...
            self.__conn = http.client.HTTPSConnection(self.__url.hostname, port=None, timeout=self.timeout)
        else:
